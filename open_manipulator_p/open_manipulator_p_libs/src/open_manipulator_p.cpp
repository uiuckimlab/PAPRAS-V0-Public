...
void OpenManipulator::initOpenManipulator(bool using_actual_robot_state, STRING usb_port, STRING baud_rate, float control_loop_time, bool with_gripper, int arm_id)
{
  /*****************************************************************************
  ...
  *****************************************************************************/
  ...
  addJoint("joint1",   // my name
           ...
           "joint2",   // child name
            ...
            1+(arm_id-1)*6,         // actuator id = joint_pos+(arm_id-1)*6
  ...
  *****************************************************************************/
  ...
  if (using_actual_robot_state)
  {
    ...
    *****************************************************************************/
    ...
    jointDxlId.push_back(3+(arm_id-1)*6);
    ...
    *****************************************************************************/
    ...
    enableAllActuator();
    ROS_INFO_STREAM("After enableAllActuator");
