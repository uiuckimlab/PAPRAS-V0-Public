...
int main(int argc, char** argv) {
  ...
  // Over Counter
  arm_goal = {0.0, 0.0, 1.0, 0.0, 0.570, 0.0};
  group.setStartStateToCurrentState();
  ...
  // Over Sink
  arm_goal = {-0.509, 1.210, 0.022, -0.611, 1.570, -0.162};
  group.setStartStateToCurrentState();
  group.setJointValueTarget(arm_goal);
  error_code = group.plan(plan);
  visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to continue the demo");
  ...
  // Into Sink
  arm_goal = {-1.120, 1.384, 0.119, -1.134, 1.570, -0.542};
  group.setStartStateToCurrentState();
  group.setJointValueTarget(arm_goal);
  error_code = group.plan(plan);
  visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to continue the demo");
  ...
  // Over Sink with Plate
  arm_goal = {-0.429, 1.155, -0.126, -0.856, 1.500, -0.162};
  group.setStartStateToCurrentState();
  group.setJointValueTarget(arm_goal);
  error_code = group.plan(plan);
  visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to continue the demo");
  ...
  // Over Dishwasher
  arm_goal = {0.836, -0.077, 0.109, 0.056, 1.471, -0.162};
  group.setStartStateToCurrentState();
  group.setJointValueTarget(arm_goal);
  error_code = group.plan(plan);
  visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to continue the demo");
  ...
  // Into Dishwasher
  arm_goal = {1.389, -0.072, 0.118, 0.405, 1.468, -0.099};
  group.setStartStateToCurrentState();
  group.setJointValueTarget(arm_goal);
  error_code = group.plan(plan);
  visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to continue the demo");
